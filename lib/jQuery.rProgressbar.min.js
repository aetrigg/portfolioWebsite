...
(function($) {
    ...
    $.fn.rProgressbar = function(options) {
        options = $.extend({ percentage: null, ShowProgressCount: true, duration: 1000, fillBackgroundColor: '#ffffff', backgroundColor: '#ffffff', borderRadius: '0px', height: '10px', width: '100%' }, options);
        $.options = options;
